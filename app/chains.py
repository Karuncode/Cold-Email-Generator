...
class Chain:
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are (your_Name), a business development executive at (Company_name). (Your_Company_Name) an AI & Software Consulting company dedicated to facilitating
            ...
            Remember you are (your_name, BDE at (Company_name). 
